 ...
 *
 * @author Mark Coates, Bernard Design, Inc.
 * @copyright Copyright © 2004-2006, BiNC
 */

/* Import plugin specific language pack */
tinyMCE.importPluginLanguagePack('binc_advimage');

var TinyMCE_BincAdvancedImagePlugin = {
	getInfo : function() {
		return {
			longname : 'BiNC Advanced image',
			author : 'Bernard Design, Inc.',
			authorurl : 'http://bernarddesign.com',
			infourl : 'http://bernarddesign.com',
	...
	getControlHTML : function(cn) {
		switch (cn) {
			case "binc_image":
				return tinyMCE.getButtonHTML(cn, 'lang_image_desc', '{$themeurl}/images/image.gif', 'mceBincAdvImage');
		}
	...
	execCommand : function(editor_id, element, command, user_interface, value) {
		switch (command) {
			case "mceBincAdvImage":
				var template = new Array();

				template['file']   = '../../plugins/binc_advimage/image.htm';
				template['width']  = 480;
				template['height'] = 650;
...
tinyMCE.addPlugin("binc_advimage", TinyMCE_BincAdvancedImagePlugin);
